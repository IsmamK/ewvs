...
const Services = () => {
    ...
    return (
        <div className="relative">
            {/* Hero Section */}
            <div className="bg-csc text-black pb-6 sm:pb-8 lg:pb-12 pt-24">
                    ...
                    <section className="flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row">
                        ...
                        <div className="flex flex-col justify-center sm:text-center lg:py-12 lg:text-left xl:w-5/12 xl:py-24">
                            ...
                            <div className="flex flex-col gap-2.5 sm:flex-row sm:justify-center lg:justify-start">
                                <a href={service.startLink} className="inline-block rounded-lg bg-black text-csc px-8 py-3 text-center text-sm font-semibold  outline-none ring-indigo-300 transition duration-100 hover:bg-indigo-600 focus-visible:ring active:bg-indigo-700 md:text-base">Start now</a>
            ...
            {/* Main Content */}
            <div className="bg-white py-6 sm:py-8 lg:py-12 text-csc">
                <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
                    ...
                    <div className="grid gap-8 sm:grid-cols-2 md:gap-12 xl:grid-cols-3 xl:gap-16">
                        {service.features.map((feature, index) => (
                            <div key={index} className="flex gap-4 md:gap-6">
                                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-black text-csc shadow-lg md:h-14 md:w-14 md:rounded-xl">
